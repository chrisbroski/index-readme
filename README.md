...
Index README is a stand alone HTML page that automatically converts a repository's README.md to a web page. Just put a copy of the *index.html* page in the root directory of your GitHub repository, and when you deploy to [GitHub Pages](https://pages.github.com/), your README.md file will converted to HTML and used as the default web page.
